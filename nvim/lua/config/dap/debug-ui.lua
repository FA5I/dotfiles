...
cmd('DapShowLog',
    'split | e ' .. vim.fn.stdpath('cache') .. '/dap.log | normal! G', {})
cmd('DapContinue', function() require('dap').continue() end, {nargs = 0})
cmd('DapToggleBreakpoint', function() require('dap').toggle_breakpoint() end,
    {nargs = 0})
...
cmd('DapRestartFrame', function() require('dap').restart_frame() end,
    {nargs = 0})
